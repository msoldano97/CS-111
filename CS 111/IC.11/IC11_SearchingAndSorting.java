...
public class IC11_SearchingAndSorting {
	...
	public static void main(String[] args)
	{
		...
		System.out.println("~~~The Original numbers Array~~~");
		System.out.print("[");
		...
		System.out.println("~~~After Sorting the numbers Array~~~");
		//System.out.println(Arrays.toString(numbers));
		ArrayUtils.selectionSort(numbers);
		System.out.println(Arrays.toString(numbers));
		System.out.println();
		System.out.println("~~~After Reversing the numbers Array~~~");
